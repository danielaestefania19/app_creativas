...
// Definimos una ruta POST para cargar archivos
...
// Definimos una ruta GET para recuperar archivos por CID
...
app.listen(5000, '192.168.1.9', () => {
    console.log('El servidor está escuchando en http://192.168.1.9:5000');
})};
