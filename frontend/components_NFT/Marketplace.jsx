      ...
      {assets.map((asset, index) => {
        ...
        useEffect(() => {
          const fetchImage = async () => {
            try {
              const response = await axios.get(`http://192.168.1.8:1234/fetchImage/${asset.tokenHash}`, {
                responseType: 'blob',
              });
          ...
          const fetchPdf = async () => {
            try {
              const response = await axios.get(`http://192.168.1.8:1234/fetchImage/${asset.businessPlanHash}`, {
                responseType: 'blob',
              });
