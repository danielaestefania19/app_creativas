...
const AddAsset = () => {
    ...
    const addAsset = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.1.7:8000/uploadImage', formData, {
                headers: {
            ...
            if (response.status === 201) {
                ...
                const pdfResponse = await axios.post('http://192.168.1.7:8000/uploadPDF', pdfFormData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                });
